...
# sed -i "s/#define FOO bar/#define FOO baz/" sdk/ZCE_EM7231T/platforms/bk7231t/bk7231t_os/beken378/file_to_change.c
# or, let's assume you made a local change to your SDK
# and make a diff from that change (inside sdk/ZCE_EM7231T/)
...
#
# patch -p 1 -d sdk/ZCE_EM7231T < platforms/BK7231T/my_change.diff
