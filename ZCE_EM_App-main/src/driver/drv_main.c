...
static driver_t g_drivers[] = {
	...
	//drvdetail:{"name":"PWMG",
	//drvdetail:"title":"TODO",
	//drvdetail:"descr":"PWM Groups (synchronized PWMs) driver for ZCE EM.",
	//drvdetail:"requires":""}
	{ "PWMG",                                // Driver Name
	PWMG_Init,                               // Init
	NULL,                                    // onEverySecond
	...
	//drvdetail:"title":"TODO",
	//drvdetail:"descr":"Mechanism to perform an action based on a max. delta value and max time. Used to control Electric Vehicle chargers. See [discussion](/issues/892).",
	//drvdetail:"requires":""}
