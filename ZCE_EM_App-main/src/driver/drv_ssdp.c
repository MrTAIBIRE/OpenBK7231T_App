...
"        <manufacturer>ZCE EM</manufacturer>\r\n" \
"        <manufacturerURL></manufacturerURL>\r\n" \
"        <modelDescription>ZCE EM</modelDescription>\r\n" \
...
"   <serviceType>urn:schemas-upnp-org:service:zce_em:1</serviceType>\r\n" \
...
void DRV_SSDP_Init()
{
	...
	//cmddetail:"descr":"Generate the SSDP list of ZCE EM devices found on the network.",
