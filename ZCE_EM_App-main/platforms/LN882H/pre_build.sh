...
# sed -i "s/#define FOO bar/#define FOO baz/" sdk/OpenLN882H/project/ZCE EM/cfg/file_to_change.h
...
LWIPOPTS="sdk/OpenLN882H/components/net/lwip-2.1.3/src/port/ln_osal/include/lwipopts.h"

if [ -f "$LWIPOPTS" ]; then
	echo "PREBUILD: enabling lwIP mDNS options for LN882H"
