...
# sed -i "s/#define FOO bar/#define FOO baz/" sdk/ZCE_EM7231N/platforms/bk7231n/bk7231n_os/beken378/file_to_change.c
# or, let's assume you made a local change to your SDK
# and make a diff from that change (inside sdk/ZCE_EM7231N/)
...
#
# patch -p 1 -d sdk/ZCE_EM7231N < platforms/BK7231N/my_change.diff
