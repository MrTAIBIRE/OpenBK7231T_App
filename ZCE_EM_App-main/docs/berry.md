...
Berry is a lightweight scripting language designed for small embedded systems. In ZCE EM, Berry provides a more powerful alternative to the built-in scripting system, with features like:
...
While ZCE EM's built-in scripting is great for simple automation tasks, Berry offers several advantages:
...
**Note: Berry support in ZCE EM is currently experimental.** The API and functionality may change in future releases without notice.
