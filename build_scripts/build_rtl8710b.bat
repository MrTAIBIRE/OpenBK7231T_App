...
echo ==============================================
echo Building ZCE EM RTL8710B on Windows natively
...
set "TOOLCHAIN_ROOT=%CD%\sdk\ZCE_EM7231N\platforms\BK7231N\toolchain\windows\gcc-arm-none-eabi-4_9-2015q1"
